...
const ItemProgresso = ({completed, number, title, showLine=false}: ItemProgressoProps) => {
    ...
    return <>
        {completed ?
            <li className={"flex md:w-full items-center text-blue-600 dark:text-blue-500"+completedClassNamesLine}>
            ...
            :
            <li className={"flex md:w-full items-center text-gray-200 dark:text-gray-500" + classNamesLine}>
                <span className="flex items-center after:content-['/'] sm:after:hidden after:mx-2 after:text-gray-200 dark:after:text-gray-500">

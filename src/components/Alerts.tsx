...
export const WarningAlert = ({title = "Atenção", message}: AlertProps) => {
    return (
...
export const SuccessAlert = ({title = "Sucesso", message}: AlertProps) => {
    return (
...
export const ErrorAlert = ({title = "Erro", message, action}: AlertProps) => {
    return (
        <div onClick={(e) => action(e)} title="Duplo-clique para esconder"

        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/conta' || pathname.includes('conta')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <BiSolidUserAccount />
                        Minha Conta
                        <BiChevronDown className={`text-2xl absolute right-4 top-1/2 -translate-y-1/2 fill-current ${
                            open && 'rotate-180'
                          }`}/>
                      </NavLink>
                      {/* <!-- Dropdown Menu Start --> */}
              ...
              <li>
                <NavLink
                  to="/pix"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('transferencias') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <BiDollar />
